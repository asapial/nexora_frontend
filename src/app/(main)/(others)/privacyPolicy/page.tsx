...
**Integrity Signals:** Sustained integrity signals may be recorded with timestamps, duration, confidence, device category, confirmation observations, and limited technical metadata. Prescription spectacles are not treated as prohibited devices. If glare or occlusion makes iris landmarks unreliable, those eye frames are ignored and eye warnings may be disabled while other safeguards remain active. Device warnings require repeated, spatially consistent observations. Lighting, camera angle, movement, and object-detector limitations can still affect a signal. Signals are provided to the exam teacher for human review and do not automatically fail an exam or declare that a student cheated.
