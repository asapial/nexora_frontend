"use client";
// My Learning:   /student/courses           (default export)
// Course Player: /student/courses/[courseId] (named export)
...
function AmbientBg({ player }: { player?: boolean }) {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden select-none">
      ...
      {player
        ? <div className="absolute top-0 left-0 right-0 h-64 bg-gradient-to-b from-teal-950/10 to-transparent" />
        : <>
            <div className="absolute -top-60 -right-40 w-[500px] h-[500px] rounded-full bg-teal-500/[0.06] blur-[120px]" />
...
export default function MyLearningPage() {
  ...
  return (
    <div className="relative flex flex-col gap-6 p-5 lg:p-8 pt-6 max-w-6xl mx-auto w-full min-h-screen">
      <AmbientBg />
